...
class ToolTip(Entity):
    def __init__(self, window, shape = shape.Rect, width = 100, height = 50, color = color.Color(0, 0, 0, 100), font_file = None, font_name = "arial", font_size = 24, text = "", text_x = 0, text_y = 0):
        super().__init__(
            window = window, 
            shape = shape, 
            width = width, 
...
if __name__ == "__main__":
    ...
    entity.add_script(ToolTip(forge, text = "Entity"))

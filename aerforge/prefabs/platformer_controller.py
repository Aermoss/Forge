...
class PlatformerController(Entity):
    def __init__(self, window, shape = shape.Rect, x = 0, y = 0, width = 50, height = 100, color = color.Color(240, 240, 240), jump_force = -13, gravity = 0.6, sprint_speed = 10, walk_speed = 5):
        super().__init__(
            window = window,
            shape = shape,
            width = width,
